    ...
    return (
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="mt-20 flex flex-col items-center gap-4 sm:flex-row sm:items-start">
              <div className="w-full flex justify-center sm:justify-start gap-4 flex-col sm:flex-row">
                
                <a
                  href="#projects"
                  className="inline-flex h-[56px] w-[260px] items-center justify-center bg-[#D4A827] hover:bg-[#655119] hover:text-[#D4A827] px-10 font-mono text-[14px] font-semibold uppercase tracking-[0.16em] text-[#1e1e1e] no-underline"
                >
                  View Projects
                </a>
                ...
                <a
                  ...
                  className="inline-flex h-[56px] w-[220px] items-center justify-center border border-[#ffffff33] bg-transparent hover:bg-[#2a2a2a] px-10 font-mono text-[14px] uppercase tracking-[0.16em] text-[#F2EAD8] no-underline"
                >
                  Contact Me
                </a>
